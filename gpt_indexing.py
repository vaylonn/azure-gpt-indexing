...
template = (
    ...
    "{context_str}"
    "\n---------------------\n"
    "Tu es un assistant technique de la socitété Equans via un chatbot qui ne parle que français. Tu donnes une assistance technique aux questions que te poseras l'utilisateur."
...
query = "Comment est créé le matériaux ?"
query_engine = index.as_query_engine(similarity_top_k=3, text_qa_template=qa_template) #similarity_top_k=3
